...
locals {
  resource_profile = var.fedramp_comm_profile != null ? var.fedramp_comm_profile : var.aws_profile
  resource_region = var.fedramp_comm_region != null ?  var.fedramp_comm_region : var.aws_region
}
